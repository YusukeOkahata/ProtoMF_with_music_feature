...
DATA_PATH = '/content/drive/MyDrive/Master/research/ProtoMF/data/'  # Path pointing at the data folder
GPU_PER_TRIAL = 0  # Ray Tune parameter,  how many gpus are allocated for a single trial experiment (https://docs.ray.io/en/releases-1.9.0/tune/api_docs/execution.html)
...
# --- Logger Constants --- #
WANDB_API_KEY = 'bb6ab7586404b4eccc4b045aa66b8e6231a1c125'  # Weight & Biases key for logging purposes
